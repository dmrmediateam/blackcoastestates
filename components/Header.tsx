...
export default function Header() {
  ...
  return (
    <header className="dark fixed top-0 left-0 right-0 z-50 bg-bce-black/95 backdrop-blur-md border-b border-bce-border">
      <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <div className="hidden lg:flex items-center gap-2">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 text-[0.8125rem] font-medium text-bce-black bg-bce-gold px-5 py-2 hover:bg-bce-gold-light transition-colors tracking-wide shrink-0"
          >
